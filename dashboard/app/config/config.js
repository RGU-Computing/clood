  ...
  $scope.saveCasebase = function() {
   ...
   $scope.saveCase = function() {
    ...
    angular.forEach($scope.newCase.project.attributes, function(value, key) {
      ...
      else if(value.type == "Object" && $scope.newCase.data[value.name] != null && $scope.newCase.data[value.name] != ""){
        $scope.newCase.data[value.name] = JSON.parse($scope.newCase.data[value.name]);
      }
      else if(value.type=="Integer" && $scope.newCase.data[value.name] != null && $scope.newCase.data[value.name] != ""){
        $scope.newCase.data[value.name] = parseInt($scope.newCase.data[value.name]);
      }
    });
